...
function renderLine(tableStyle, columns, row, isHeader) {
    ...
    columns.forEach((column) => {
        ...
        line.addWithColor((isHeader && table_constants_1.defaultHeaderFontColor) || column.color || row.color, // column color is priotized as row color
...
function renderTable(table) {
    tablePreProcessors_1.preProcessColumns(table); // enable / disable cols, find maxLn of each col/ computed Columns
